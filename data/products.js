...
export function loadProducts(fun) {//the parameter in the function is considered a callback which is a function to run in the future 
  ...
  xhr.addEventListener("load", () => {
    ...
    }); //basically ensuring the type of cart is set properly as clothing has seperate functionality
  ...
  xhr.send(); //this is async so we need to write code that will wait for the response
}
